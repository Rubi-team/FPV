...
namespace KinematicCharacterController.Examples
{
    ...
    {
        [SerializeField] TMP_Text AvgFPS;
        [SerializeField] TMP_Text AvgFPSMin;
        [SerializeField] TMP_Text AvgFPSMax;
        [SerializeField] TMP_Text PhysicsRate;
        [SerializeField] TMP_Text PhysicsFPS;
        [SerializeField] float PollingRate = 1f;
